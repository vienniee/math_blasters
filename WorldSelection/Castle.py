    ...
    def __init__(self, xpos,level,chapter):
        ...
        if int(level) == 1:
            ...
            castle_image = pygame.image.load(os.path.join(os.path.dirname(
                __file__), "graphics", "castle", "castle_level1.png")).convert_alpha()
            castle_image = pygame.transform.rotozoom(castle_image, 0, 5)
        elif int(level) == 2:
            castle_image = pygame.image.load(os.path.join(os.path.dirname(
                __file__), "graphics", "castle", "castle_level2.png")).convert_alpha()
            castle_image = pygame.transform.rotozoom(castle_image, 0, 5)
        elif int(level) == 3:
            castle_image = pygame.image.load(os.path.join(os.path.dirname(
                __file__), "graphics", "castle", "castle_level3.png")).convert_alpha()
            castle_image = pygame.transform.rotozoom(castle_image, 0, 5)
