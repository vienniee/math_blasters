...
class Player(pygame.sprite.Sprite):
    def __init__(self, gender):
        ...
        if self.gender == "male":
            # male
            loginImage = pygame.image.load(os.path.join(os.path.dirname(
                __file__), 'login_images', 'img0.png')).convert_alpha()
            MwalkR1 = pygame.image.load(os.path.join(os.path.dirname(
                __file__), 'Image', 'male', 'walk', 'adventurer-run-00.png')).convert_alpha()
            MwalkR2 = pygame.image.load(os.path.join(os.path.dirname(
                __file__), 'Image', 'male', 'walk', 'adventurer-run-01.png')).convert_alpha()
            MwalkR3 = pygame.image.load(os.path.join(os.path.dirname(
                __file__), 'Image', 'male', 'walk', 'adventurer-run-02.png')).convert_alpha()
            MwalkR4 = pygame.image.load(os.path.join(os.path.dirname(
                __file__), 'Image', 'male', 'walk', 'adventurer-run-03.png')).convert_alpha()
            MwalkR5 = pygame.image.load(os.path.join(os.path.dirname(
                __file__), 'Image', 'male', 'walk', 'adventurer-run-04.png')).convert_alpha()
            MwalkR6 = pygame.image.load(os.path.join(os.path.dirname(
                __file__), 'Image', 'male', 'walk', 'adventurer-run-05.png')).convert_alpha()

            MwalkL1 = pygame.image.load(os.path.join(os.path.dirname(
                __file__), 'Image', 'male', 'walk', 'adventurer-runL-00.png')).convert_alpha()
            MwalkL2 = pygame.image.load(os.path.join(os.path.dirname(
                __file__), 'Image', 'male', 'walk', 'adventurer-runL-01.png')).convert_alpha()
            MwalkL3 = pygame.image.load(os.path.join(os.path.dirname(
                __file__), 'Image', 'male', 'walk', 'adventurer-runL-02.png')).convert_alpha()
            MwalkL4 = pygame.image.load(os.path.join(os.path.dirname(
                __file__), 'Image', 'male', 'walk', 'adventurer-runL-03.png')).convert_alpha()
            MwalkL5 = pygame.image.load(os.path.join(os.path.dirname(
                __file__), 'Image', 'male', 'walk', 'adventurer-runL-04.png')).convert_alpha()
            MwalkL6 = pygame.image.load(os.path.join(os.path.dirname(
                __file__), 'Image', 'male', 'walk', 'adventurer-runL-05.png')).convert_alpha()

            MidleL = pygame.image.load(os.path.join(os.path.dirname(
                __file__), 'Image', 'male', 'idleL', 'L0.png')).convert_alpha()
