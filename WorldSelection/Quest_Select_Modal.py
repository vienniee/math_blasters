...
class Quest_menu(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        quest_menu = pygame.image.load('graphics/quest/quest_background.png').convert_alpha()
...
def load_asset(subject):
    ...
    questButtonImage = pygame.image.load('graphics/teacher/assignquestselect_img1.png').convert_alpha()
    backButtonImage = pygame.image.load('graphics/teacher/assignquestselect_img0.png').convert_alpha()
    nextButtonImage = pygame.image.load('graphics/teacher/assignquestselect_img8.png').convert_alpha()
    prevButtonImage = pygame.image.load('graphics/teacher/assignquestselect_img9.png').convert_alpha()
